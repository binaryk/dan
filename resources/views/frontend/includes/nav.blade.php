<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            ...
            {{ link_to_route('frontend.index', env('APP_NAME'), [], ['class' => 'navbar-brand']) }}
        </div><!--navbar-header-->
        ...
        <div class="collapse navbar-collapse" id="frontend-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>{{ link_to_route('frontend.contact', 'Despre', [], ['class' => active_class(Active::checkRoute('frontend.contact')) ]) }}</li>
            </ul>
        </div><!--navbar-collapse-->
    </div><!--container-->
</nav>